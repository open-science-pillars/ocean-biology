...
A domain capability: discipline Ocean Biology inside the Biosphere sphere. Pillar means sphere: one of the five Earth science spheres; a capability is skills, knowledge signed by its stewards and deterministic checks, delivered as one plugin.
...
Ocean color, phytoplankton and marine biogeochemistry: the living ocean
and its carbon. Ocean physics stays in ocean-science; the two meet where
a composite would.
...
here relies on: OB.DAAC (PACE, MODIS and VIIRS ocean color). None engaged yet.
